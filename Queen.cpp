...
#define n 8
#define eps 2
#define pm 0.8  //Mutation Probablity
...
void selection(int mating_pool[][n],int chromosome[][n],double fitness[],int population_size)
{
...
void crossover(int mating_pool[][n],int chromosome[200][n],int population_size)
{
...
//Swap Mutation
void mutation(int chromosome[][n],int population_size)
{
...
int main()
{
	...
	double fitness[200];
	srand(time(NULL));
	printf("n-Queen Problem Solution!Fitness Function:1/(2+conflicts)\n");
